# Bedrock-compatible entrypoint — run this instead of app.py
# Usage: streamlit run app_bedrock.py --server.port 8501
"""
SRE Incident Dashboard with Bedrock-powered agent.
Uses AWS IAM credentials (instance profile or env vars) instead of Anthropic API key.
"""
import json
...
from provided_bedrock import chat_panel

load_dotenv()
st.set_page_config(page_title="Incident · 2277", page_icon="▮", layout="wide")
inject_style()

# Generate the synthetic log fixture on first run
